<template>
  ...
  <div v-else class="app-layout">
    <aside class="sidebar" :class="{ open: mobileMenu }">
      ...
      <div class="goal-card"><div><span>今日目标</span><strong>2 / 3 组</strong></div><div class="progress"><i style="width:66%"></i></div><small>再完成 1 组，获得 5 积分</small></div>
    ...
    <main class="main-shell">
      <header class="topbar">
        ...
        <div class="top-actions"><button class="points-pill" @click="go('points')">◆ <strong>126</strong> 积分</button><button class="notify">♢<i></i></button><span class="avatar small">林</span></div>
      </header>
