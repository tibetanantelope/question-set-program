...
CREATE TABLE IF NOT EXISTS `knowledge_mastery` (
    ...
    `mastery_score` INT NOT NULL DEFAULT 50 COMMENT '掌握度内部估计: 0-100；无证据时显示待评估',
    `learning_status` VARCHAR(32) NOT NULL DEFAULT 'weak' COMMENT 'weak/consolidating/mastered',
